        ...
        <div className="min-h-screen w-full flex items-center justify-center">
            <Card className="w-[380px] px-5">
                <CardHeader className="text-center">
                    <div className="mb-4 x-auto flex size-20 items-center justify-center rounded-full bg-blue-100">
                ...
                <CardContent>
                    <div className="mt-4 rounded-md bg-yellow-5 border-yellow-300 p-4">
